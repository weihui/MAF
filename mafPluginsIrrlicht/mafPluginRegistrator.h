 ...
 */
class MAFPLUGINSIRRLICHTSHARED_EXPORT mafPluginRegistrator {
public:
    /// Object costructor
...
extern "C" MAFPLUGINSIRRLICHTSHARED_EXPORT mafResources::mafPluginInfo pluginInfo() {
    mafResources::mafPluginInfo info;
    info.m_Version = 1.0;
    info.m_PluginName = "Plugins for Irrlicht";
...
extern "C" MAFPLUGINSIRRLICHTSHARED_EXPORT void registerPlugin() {
